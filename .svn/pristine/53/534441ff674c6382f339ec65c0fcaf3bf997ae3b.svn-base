...
const taskAutoComplete = () => {
  document.getElementById("taskinsertTitle").value = "환자 퇴원 기능"; // 나중에 고쳐야함
  document.getElementById("taskinsertStts").value = "P003-1";
  $("#taskInsertPic").val("S2301201");
  document.getElementById("taskinsertBengDt").value = "2023-08-03"; // 나중에 고쳐야함
  document.getElementById("taskinsertDdlnDt").value = "2023-08-07"; // 나중에 고쳐야함
