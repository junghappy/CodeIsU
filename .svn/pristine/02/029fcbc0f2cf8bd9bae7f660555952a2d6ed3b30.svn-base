		...
		<div id="resume-preview">
			...
			<div class="basic-info">
				<div class="container">
					<div class="photo">
						<!--기본이미지-->
						<img src="${pageContext.request.contextPath}/resources/img/resume/img_profile_default.gif" />
					...
					<div class="item height-fix"> <!-- 고등학교 졸업 -->
						...
						<div class="content">
							<div class="content-header">
								...
								<div class="sub-txt">${res.highschType}</div>
				...
				<div class="header">
					...
					<div class="list">
						<table width="100%" class="resume-table">
							...
							<c:if test="${status.end%2 eq 0 && stat.last}">
								<th> - </th>
								<td> - </td>
								</tr>
							</c:if>
			...
			<div class="section">
				...
				<div class="list">
					<div class="item">
						<div class="txt">${res.resumeIntroConn}</div>
