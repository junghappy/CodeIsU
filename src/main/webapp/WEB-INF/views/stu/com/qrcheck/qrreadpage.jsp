...
<body>
  ...
  <nav class="navbar bg-white">
    <div class="container-fluid">
      <span class="navbar-brand mb-0 h1"><img src="/resources/img/codeisu_logo_m.gif" style="height: 25px;" alt="" ></span>
      <span class="h3">스마트QR 출결시스템</span>
    </div>
  </nav>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        ...
        <span class="page-title text-truncate text-dark font-weight-medium mb-1">스마트 QR인증 (현재시간: <span id="pTime"></span>)</span>
