    ...
    $('#myModal').on('shown.bs.modal', function () {
        ...
        $(document).on("change", "#attdanCdSelect", function(e) {
            ...
            if (attdanCd == "S003-1"){
                ...
                tdStr += '<td>';
                tdStr += '  <input type="time" class="form-control attdanStartTime attdanTime" value="22:33:00">';
                tdStr += '  ~';
                tdStr += '  <input type="time" class="form-control attdanEndTime attdanTime" value="22:33:00">';
                tdStr += '</td>';
