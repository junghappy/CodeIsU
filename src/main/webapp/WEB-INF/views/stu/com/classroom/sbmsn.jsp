							...
							<div class="asmtcardDtl">
								...
								<c:if test="${qst.qstCode ne 'M' }">
									<div class="row align-items-center">
										...
										<div class="col-9">
											<input type="text" name="qstAnswerList[${num}].qstSbmsnAns"  class="form-control font-weight-normal border-0 rounded-0
                        shadow-none border-bottom border-dark qstnAns" placeholder="답">
										</div>
										<div class="col-2"></div>
									</div>
								</c:if>
